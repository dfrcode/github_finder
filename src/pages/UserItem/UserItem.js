          ...
          >
            ...
            >
              ...
              {hireable !== false && hireable !== null ? (
                ...
                >
                  <FaCheckCircle
                    style={{ marginRight: "5px", fill: "green" }}
                  />{" "}
                  hariabled
                </p>
              ) : (
              ...
              >
                <Link
                  ...
                  style={{
                    ...
                    padding: "5px 12px",
                    fontSize: "12px",
                    backgroundColor: this.state.color_back ? "#eee" : "#272727",
                    color: this.state.color_back ? "#222" : "#fff",
                    transition:
                      "background-color 0.2s linear, color 0.2s linear",
                  }}
                  onMouseOver={() => this.setState({ color_back: false })}
                  onMouseLeave={() => this.setState({ color_back: true })}
                >
                  Back to Search
                </Link>
                <Link
                  ...
                  style={{
                    ...
                    padding: "5px 12px",
                    fontSize: "12px",
                    backgroundColor: this.state.color_github
                      ? "#272727"
                      : "#eee",
                    color: this.state.color_github ? "#fff" : "#222",
                    transition:
                      "background-color 0.2s linear, color 0.2s linear",
                  }}
                  rel="noreferrer"
                  target="_blank"
                  onMouseOver={() => this.setState({ color_github: false })}
                  onMouseLeave={() => this.setState({ color_github: true })}
                >
                  To github profile
                </Link>
              </div>
